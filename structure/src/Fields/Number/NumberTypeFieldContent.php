...
class NumberTypeFieldContent implements FieldContentInterface
{
    ...
    public function render(array $settings, array $values): Markup
    {
        ...
        $this->content = new Markup($this->twigEngine->render('@structure/fields/field/number/content.html.twig', [
