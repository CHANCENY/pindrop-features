...
class TextFormattedTypeFieldContent implements FieldContentInterface
{
    ...
    public function render(array $settings, array $values): Markup
    {
        ...
        $this->values = $values;
        $this->content = new Markup($this->twigEngine->render('@structure/fields/field/text_formatted/content.html.twig', [
