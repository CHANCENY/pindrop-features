...
class EmailTypeWidget implements FieldTypeWidgetInterface
{
    ...
    {
        return new Markup($this->twig->render("@structure/fields/email/type_widget.html.twig", $options), 'utf-8');
    }
    ...
    {
        return new Markup($this->twig->render("@structure/fields/email/type_widget_form_settings.html.twig", $options), 'utf-8');
    }

    public function getDisplaySettings(array $options): Markup
    {
        return new Markup($this->twig->render("@structure/fields/email/type_widget_display.html.twig", $options), 'utf-8');
    }
}
