...
class FieldsetTypeFieldContent implements FieldContentInterface
{
    ...
    public function render(array $settings, array $values): Markup
    {
        ...
        $this->content = new Markup($this->twigEngine->render('@structure/fields/field/fieldset/content.html.twig', [
